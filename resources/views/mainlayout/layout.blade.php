...
<body>
        ...
        <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                <div class="navbar-nav m-auto py-0">
                    <a href="/" class="nav-item nav-link {{ Request::is('welcome') ? 'active' : '' }}">Home</a>
    ...
    <div class="jumbotron jumbotron-fluid mb-5">
        <div class="container text-center py-5">
            ...
            <form id="trackingForm" action="{{ route('tracking') }}" method="post">
            ...
            <div class="mx-auto" style="width: 100%; max-width: 600px;">
                <div class="input-group">
                     ...
                     <input type="text" id="trackingId" name="id" class="form-control border-light" style="padding: 30px;" placeholder="Tracking Id">
                    <div class="input-group-append">
                         <button class="btn btn-primary px-3" type="submit" id="trackButton">Track & Trace</button>
                    </div>
                    </form>
                </div>
            </div>
    ...
    <div class="container-fluid bg-dark text-white mt-5 py-5 px-sm-3 px-md-5">
        <div class="row pt-5">
            <div class="col-lg-7 col-md-6">
                <div class="row">
                    <div class="col-md-6 mb-5">
                        ...
                        <p><i class="fa fa-map-marker-alt mr-2"></i>Defence Plaza, Hyderabad</p>
                        <p><i class="fa fa-phone-alt mr-2"></i>+92 333 2612187</p>
                        <p><i class="fa fa-envelope mr-2"></i>info@techsys.com.pk</p>
            ...
            <div class="col-lg-5 col-md-6 mb-5">
                ...
                <p>Please keep in touch through Email, we shall update you through News letter</p>
                <div class="w-100">
                    <div class="input-group">
    ...
    <div class="container-fluid bg-dark text-white border-top py-4 px-sm-3 px-md-5" style="border-color: #3E3E4E !important;">
        <div class="row">
            <div class="col-lg-6 text-center text-md-left mb-3 mb-md-0">
                <p class="m-0 text-white">&copy; <a href="#">Trustline couriers</a>. All Rights Reserved. 
				
				<!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
				Designed by <a href="#">Techsys</a>
                </p>
            </div>
        ...
        .then(data => {
            if (data.status === 'success') {
                Swal.fire({
                    ...
                    html: `<p>Sender: ${data.data.sname}</p>
                           <p>Receiver: ${data.data.rname}</p>
                           <p>Address: ${data.data.receiveraddress}</p>
                           <p>Charges: ${data.data.charges}</p>`,
                    icon: 'success',
                });
            } else {
                Swal.fire({
